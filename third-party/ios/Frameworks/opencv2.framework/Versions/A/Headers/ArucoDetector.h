 ...
 * @see `undistort`, `estimatePoseSingleMarkers`, `estimatePoseBoard`
 */
- (void)detectMarkersWithConfidence:(Mat*)image corners:(NSMutableArray<Mat*>*)corners ids:(Mat*)ids markersConfidence:(Mat*)markersConfidence rejectedImgPoints:(NSMutableArray<Mat*>*)rejectedImgPoints NS_SWIFT_NAME(detectMarkersWithConfidence(image:corners:ids:markersConfidence:rejectedImgPoints:));
 ...
 * @see `undistort`, `estimatePoseSingleMarkers`, `estimatePoseBoard`
 */
- (void)detectMarkersWithConfidence:(Mat*)image corners:(NSMutableArray<Mat*>*)corners ids:(Mat*)ids markersConfidence:(Mat*)markersConfidence NS_SWIFT_NAME(detectMarkersWithConfidence(image:corners:ids:markersConfidence:));
