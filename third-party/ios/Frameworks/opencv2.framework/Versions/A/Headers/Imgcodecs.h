 ...
 *
 * Member enums: `ImreadModes`, `ImwriteFlags`, `ImwriteJPEGSamplingFactorParams`, `ImwriteTiffCompressionFlags`, `ImwriteTiffPredictorFlags`, `ImwriteTiffResolutionUnitFlags`, `ImwriteEXRTypeFlags`, `ImwriteEXRCompressionFlags`, `ImwritePNGFlags`, `ImwritePNGFilterFlags`, `ImwritePAMFlags`, `ImwriteHDRCompressionFlags`, `ImwriteBMPCompressionFlags`, `ImwriteGIFCompressionFlags`, `ImageMetadataType`
 */
