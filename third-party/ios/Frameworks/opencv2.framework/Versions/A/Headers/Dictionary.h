...
//
// static Mat cv::aruco::Dictionary::getBitsFromByteList(Mat byteList, int markerSize, int rotationId = 0)
//
/**
 * Transform list of bytes to matrix of bits
 */
+ (Mat*)getBitsFromByteList:(Mat*)byteList markerSize:(int)markerSize rotationId:(int)rotationId NS_SWIFT_NAME(getBitsFromByteList(byteList:markerSize:rotationId:));
