...
import { IMAGENET_LABELS, type ImageNetLabel } from './constants/classification';
...
const EFFICIENTNET_V2_S_XNNPACK_INT8: ClassifierModel<ImageNetLabel> = {
...
const EFFICIENTNET_V2_S_XNNPACK_FP32: ClassifierModel<ImageNetLabel> = {
  modelPath: `${BASE_URL}-efficientnet-v2-s/${VERSION_TAG}/xnnpack/efficientnet_v2_s_xnnpack_fp32.pte`,
  classifierOpts: EFFICIENTNET_V2_S_OPTS,
};
const EFFICIENTNET_V2_S_COREML_FP16: ClassifierModel<ImageNetLabel> = {
